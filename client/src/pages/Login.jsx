    ...
    <div className="min-h-screen flex items-center justify-center p-4 w-full">
      ...
      >
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-xl font-black text-slate-950 dark:text-white uppercase tracking-tight">Operator Login</h2>
          <p className="text-xs text-slate-400 mt-1 uppercase font-semibold">Enter credentials to authenticate</p>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-slate-100 dark:border-slate-800 text-center">
          <p className="text-xs text-slate-400">
            No routing profile?{' '}
            <Link to="/signup" className="text-blue-600 dark:text-indigo-400 font-bold hover:brightness-110 transition-all">
              Initialize Profile
            </Link>
          </p>
        </div>
